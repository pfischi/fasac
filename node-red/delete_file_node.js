...
module.exports = function(RED) {
    function DeleteFileNode(config) {
        try {          
            ...
            node.on('input', async function(msg) {
                try {
                    ...
                    const jobResponse = await awxConnector.executeJob("Delete File", this.hostSshService.host, extraVars, timings);
    ...
    RED.nodes.registerType("delete-file", DeleteFileNode);
}
