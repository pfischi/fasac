...
module.exports = function(RED) {
    function ModifyDirectoryNode(config) {
        try {          
            ...
            node.on('input', async function(msg) {
                try {
                    ...
                    const recurse = msg.payload.recurse;
                    ...
                    const jobResponse = await awxConnector.executeJob("Modify Directory", this.hostSshService.host, extraVars, timings);
    ...
    RED.nodes.registerType("modify-directory", ModifyDirectoryNode);
}
